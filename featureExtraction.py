###  Machine Learning for Cyber Security Professionals -- Prof. Calix, Purdue University Northwest, Hammond, IN, USA
import os
import glob
...
for filteredFile in glob.glob('filtered_pcap/*.pcap'):
    ...
    tsharkCommand = "tshark -r " + filteredFile + " -T fields \
        	    -e ip.len -e ip.hdr_len -e ip.ttl \
                    ...
                    -e tcp.stream -e tcp.urgent_pointer -e ip.flags\
		    -e ip.id -e ip.checksum -e tcp.flags -e tcp.checksum"
